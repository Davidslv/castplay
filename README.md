...
Issues and pull requests are welcome. Start with [CONTRIBUTING.md](CONTRIBUTING.md) for the dev setup (there is no build — `node --test` is the whole loop) and the quality gates. Please also read the [Code of Conduct](CODE_OF_CONDUCT.md).
